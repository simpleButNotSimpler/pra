function image = oldedgeresponse(im, resp)
        im = imcomplement(im);

        %cmfrat filters 0, 20, 40, 60, 80, 100, 120, 140, 160
        f0 = oldcmfrat(11, 11, 0);
        f20 = oldcmfrat(11, 11, 20);
        f40 = oldcmfrat(11, 11, 40);
        f60 = oldcmfrat(11, 11, 60);
        f80 = oldcmfrat(11, 11, 80);
        f100 = oldcmfrat(11, 11, 100);
        f120 = oldcmfrat(11, 11, 120);
        f140 = oldcmfrat(11, 11, 140);
        f160 = oldcmfrat(11, 11, 160);
